...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     rust
     (python :variables python-backend 'lsp python-lsp-server 'pyright python-formatter 'yapf python-indent-offset 4)
     go
     javascript
     sql
     themes-megapack
...
(defun dsp/setup-term-mode ()
  (define-key evil-hybrid-state-map (kbd "C-r") 'dsp/send-C-r)
  (define-key evil-hybrid-state-map (kbd "C-c") 'dsp/send-C-c))

(defun dsp/io-pull ()
  (interactive)
  (shell-command "/home/dsp/.bin/iopull"))

(defun dsp/io-push ()
  (interactive)
  (shell-command "/home/dsp/.bin/iopush"))
...
before packages are loaded."
  ...
  (global-set-key (kbd "C-'") 'dsp/io-push)

  (global-set-key (kbd "M-'") 'dsp/io-pull)
  ...
  (add-hook 'term-mode-hook 'dsp/setup-term-mode)
  ...
  (setq default-frame-alist '((font . "MesloLGS NF")))
